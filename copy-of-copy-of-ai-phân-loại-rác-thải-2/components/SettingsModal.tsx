            ...
            <div className="mt-4 flex items-center justify-between bg-background/50 p-3 rounded-lg">
             ...
             <div className="mt-4 flex items-center justify-between bg-background/50 p-3 rounded-lg">
                ...
                <div className="flex items-center gap-2">
                    <button onClick={() => handleLanguageChange('vi')} className={`p-1 rounded-md ${currentSettings.language === 'vi' ? 'bg-brand-green/30 ring-2 ring-brand-green' : 'opacity-50 hover:opacity-100'}`}><VietnamFlagIcon className="w-8 h-6" /></button>
                    <button onClick={() => handleLanguageChange('en')} className={`p-1 rounded-md ${currentSettings.language === 'en' ? 'bg-brand-green/30 ring-2 ring-brand-green' : 'opacity-50 hover:opacity-100'}`}><UKFlagIcon className="w-8 h-6" /></button>
                </div>
            </div>
          </section>
